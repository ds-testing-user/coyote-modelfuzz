...
namespace Microsoft.Coyote.Actors
{
    ...
    /// </summary>
    internal sealed class ActorBasedDFSStrategy : ActorBasedInterleavingStrategy, IActorBasedStrategy
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActorBasedDFSStrategy"/> class.
        /// </summary>
        internal ActorBasedDFSStrategy(Configuration configuration)
        ...
        bool IActorBasedStrategy.InitializeNextIteration(uint iteration, ActorExecutionTrace actorTrace, ExecutionTrace trace)
        {
            ...
            if (!this.UniqueTraces.Contains(traceString))
            {
        ...
        /// <inheritdoc/>
        internal override string GetName() => "actor-based-dfs";
