...
#pragma warning disable CA1724 // Type names should not match namespaces
    ...
    public class Configuration
    {
        ...
        /// </summary>
        [DataMember]
        internal uint NumDelays;

        /// <summary>
        /// Number of delays to be injected into the schedule.
        /// </summary>
        [DataMember]
        internal string MutatorType;
        ...
        protected Configuration()
        {
            ...
            this.ExplorationStrategy = ExplorationStrategy.RandomChoice;
        ...
        public Configuration WithOutputFilePath(string outputPath)
        {
        ...
        public Configuration WithRunMode(int runMode)
        {
        ...
        /// </remarks>
        public Configuration WithRandomChoiceStrategy()
        {
            this.ExplorationStrategy = ExplorationStrategy.RandomChoice;
        ...
        /// </summary>
        public Configuration WithRoundRobinFuzzingStrategy()
        {
            this.ExplorationStrategy = ExplorationStrategy.InterleavedRoundRobinFuzzing;
            this.PortfolioMode = PortfolioMode.None;
            return this;
        }
        ...
        /// </summary>
        public Configuration WithActorBasedDFSStrategy()
        {
            this.ExplorationStrategy = ExplorationStrategy.ActorBasedDFS;
            this.PortfolioMode = PortfolioMode.None;
            return this;
        }
        ...
        /// Updates the configuration to use the interleaved round robin fuzzing exploration strategy during systematic testing.
        /// </summary>
        public Configuration WithInterleavedFuzzingStrategy()
        {
            this.ExplorationStrategy = ExplorationStrategy.InterleavedFuzzing;
            this.PortfolioMode = PortfolioMode.None;
            return this;
        }
        ...
        /// that uses a tuned portfolio of strategies.
        /// </remarks>
        public Configuration WithQLearningTLAStrategy()
        {
            this.ExplorationStrategy = ExplorationStrategy.QLearningTLA;
            this.IsImplicitProgramStateHashingEnabled = true;
            this.PortfolioMode = PortfolioMode.None;
            return this;
        }
        ...
        public Configuration WithNumDelays(uint delays)
        {
            this.NumDelays = delays;
            return this;
        }
        ...
        public Configuration WithMutatorType(string mutatorType)
        {
        ...
        public Configuration WithIndexOffset(int indexOffset)
        {
