...
namespace Microsoft.Coyote.Testing
{
    ...
    internal static class ExplorationStrategyExtensions
    {
        ...
        internal static string GetName(this ExplorationStrategy strategy) => strategy switch
            {
                ExplorationStrategy.RandomChoice => "random-choice",
                ...
                ExplorationStrategy.QLearningTLA => "q-learning-tla",
                ExplorationStrategy.DFS => "dfs",
                ExplorationStrategy.InterleavedFuzzing => "interleaved-fuzzing",
                ExplorationStrategy.InterleavedRoundRobinFuzzing => "interfeaved-round-robin-fuzzing",
                ExplorationStrategy.ActorBasedDFS => "actor-based-dfs",
        ...
        internal static ExplorationStrategy FromName(string name) => name switch
            {
                "random-choice" => ExplorationStrategy.RandomChoice,
                ...
                "q-learning-tla" => ExplorationStrategy.QLearningTLA,
                "dfs" => ExplorationStrategy.DFS,
                "interleaved-fuzzing" => ExplorationStrategy.InterleavedFuzzing,
                "interleaved-round-robin-fuzzing" => ExplorationStrategy.InterleavedRoundRobinFuzzing,
                "actor-based-dfs" => ExplorationStrategy.ActorBasedDFS,
