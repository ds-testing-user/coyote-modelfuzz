...
namespace Microsoft.Coyote.Testing.Interleaving
{
    ...
    /// </remarks>
    internal sealed class QLearningStrategyTLA : RandomStrategy
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QLearningStrategyTLA"/> class.
        /// It uses the specified random number generator.
        /// </summary>
        public QLearningStrategyTLA(Configuration configuration)
            ...
            bool isYielding, out ControlledOperation next)
        {
            ...
            // var content = null;
            // Console.WriteLine($"Current operation: {current.Runtime.}");
            ...
            Console.WriteLine($"Next operation: {next.Name}");
        ...
        /// <inheritdoc/>
        internal override string GetName() => ExplorationStrategy.QLearningTLA.GetName();
