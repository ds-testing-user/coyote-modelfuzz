...
namespace Microsoft.Coyote.SystematicTesting
{
    ...
    public class TestReport : ITestReport
    {
        ...
        /// </summary>
        [DataMember]
        public int FirstBugIteration { get; internal set; }
        ...
        public TestReport(Configuration configuration)
        {
            ...
            this.FirstBugIteration = 1000000;
        ...
        void ITestReport.SetSchedulingStatistics(bool isBugFound, string bugReport, int numOperations, int concurrencyDegree,
            int groupingDegree, int scheduledSteps, bool isMaxScheduledStepsBoundReached, bool isScheduleFair, uint iteration)
        {
            if (isBugFound)
            {
                this.NumOfFoundBugs++;
                this.BugReports.Add(bugReport);
                int iter = (int)iteration;
                this.FirstBugIteration = this.FirstBugIteration <= iter ? this.FirstBugIteration : iter;
            }
        ...
        public bool Merge(TestReport testReport)
        {
            ...
            lock (this.Lock)
            {
                ...
                this.FirstBugIteration = this.FirstBugIteration <= testReport.FirstBugIteration ? this.FirstBugIteration : testReport.FirstBugIteration;
